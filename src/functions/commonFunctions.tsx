 ...
 */
const formatDateTimeToIST = (utcDateString: string, dateOnly: boolean = true): string => {
...
export { formatDateTimeToIST, formatDateToString,
    formatTimeToString , parseTimeString, enlargeArray};